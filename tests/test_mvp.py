...
# would need to test get valid guess
# def test_submit_empty_guess():
#     # arrange
#     level = 4
#     game = Game(level)
#     game.answer = "1234"
...
#     # assert
#     assert game.lives == initial_lives  # Lives shouldn't decrement
#     assert not any(g.guess_value == "" for g in game.previous_guesses)

# would need to test get valid guess
# def test_submit_non_numeric_guess():
    # # arrange
    # level = 4
    # game = Game(level)
    # game.answer = "1234"
    # guess = Guess("abcd")  # Non-numeric guess
    # initial_lives = game.lives
    ...
    # # assert
    # assert game.lives == initial_lives  # Lives shouldn't decrement
    # assert not any(g.guess_value == "abcd" for g in game.previous_guesses)


# def test_submit_repeated_guess():
#     # arrange
#     level = 4
#     game = Game(level)
#     game.answer = "1234"
...
#     # assert
#     assert game.lives == initial_lives  # Lives shouldn't decrement
#     assert len(game.previous_guesses) == 1  # Guess shouldn't be added again
